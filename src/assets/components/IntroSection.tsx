  ...
  return (
    <>
      <section
        ...
        className="flex flex-col items-center text-center justify-around h-screen px-4 pt-16 text-text shadow-lg -z-20"
      >
        ...
        <div className="flex flex-col gap-y-3.5 items-center md:gap-y-8">
