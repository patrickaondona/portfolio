...
const Navbar = () => {
  ...
  return (
    <header className="w-full fixed z-10 bg-white">
      <nav className="w-full h-[12vh] lg:h-[15vh] flex px-6 justify-between items-center shadow-md">
        ...
        {isOpen && (
          <div className="lg:hidden flex flex-col absolute left-0 right-0 top-full z-20 w-full h-screen transition-all duration-500 ease-in-out">
            <ul
              className="bg-white border border-y-gray-300 flex flex-col items-center md:items-start md:pl-4 justify-around font-bold text-lg text-center h-[60vh] md:h-[55vh]"
            ...
            <div
              className="bg-white flex flex-col items-center justify-around h-[28vh] md:h-[33vh]"
              data-aos="my-custom-fade-down"
              data-aos-delay="600"
            >
